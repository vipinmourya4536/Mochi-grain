...
const translations: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    'trend.spike': 'Spike',
    'trend.drop': 'Drop',
    'trend.rising_rapidly': 'Rising Fast',
    'trend.falling_rapidly': 'Falling Fast',
    'trend.insufficient_data': 'Learning',
    ...
    // ── Engine v2 Messages ──
    'engine.title_safe': 'Storage is Safe',
    'engine.title_warning': 'Attention Needed',
    'engine.title_critical': 'Action Required',
    'engine.title_monitor': 'Monitor Closely',
    'engine.title_recovery': 'Conditions Improved',
    'engine.title_learning': 'Collecting Data',
    'engine.title_idle': 'Waiting...',
    'engine.title_invalid': 'Check Probe',
    'engine.safe_condition': 'All readings within normal range.',
    'engine.safe_action': 'Maintain current storage conditions.',
    'engine.moisture_stable': 'Conditions are stable. Readings consistent over the monitoring window.',
    'engine.stable_action': 'No action needed. Continue monitoring.',
    'engine.monitor_condition': 'Moisture or temperature approaching threshold. Close monitoring recommended.',
    'engine.monitor_action': 'Check ventilation. Monitor for changes.',
    'engine.warning_condition': 'Moisture above safe limit. Risk of grain quality degradation.',
    'engine.warning_action': 'Inspect storage. Improve ventilation or begin aeration.',
    'engine.high_moisture_warm': 'High moisture combined with elevated temperature. Spoilage risk increasing.',
    'engine.high_moisture_warm_action': 'Act immediately — aerate grain, reduce temperature, inspect for hot spots.',
    'engine.critical_condition': 'Dangerous moisture and temperature levels detected. Spoilage imminent.',
    'engine.critical_action': 'Begin drying immediately. Contact storage facility. Do not delay.',
    'engine.moisture_rising': 'Moisture is gradually rising. Trend detected in recent readings.',
    'engine.rising_action': 'Monitor closely. Check for moisture sources or leaks.',
    'engine.moisture_rising_rapidly': 'Moisture rising rapidly. Significant increase detected between readings.',
    'engine.rising_rapidly_action': 'Investigate immediately. Check ventilation, condensation, and grain condition.',
    'engine.recovery': 'Storage conditions have returned to safe levels. Improvement detected.',
    'engine.recovery_action': 'Conditions improving. Continue current practices.',
    'engine.insufficient_data': 'Not enough data for analysis. Collecting readings to establish baseline.',
    'engine.insufficient_data_action': 'Keep the probe connected. Analysis will improve with more readings.',
    'engine.invalid_reading': 'Sensor reading appears invalid. Check probe connection.',
    'engine.invalid_action': 'Verify the probe is properly inserted and connected.',
    'engine.stale_reading': 'Data is stale. No recent readings received.',
    'engine.stale_action': 'Check probe battery and Bluetooth connection.',
    'engine.unknown': 'Unknown state.',
    'engine.unknown_action': 'Monitor the situation.',
    'engine.idle': 'Waiting for readings...',
    'engine.idle_action': 'Ensure probe is connected and sending data.',
  ...
  hi: {
    ...
    'trend.rising_rapidly': 'तेज़ी से बढ़ रहा है',
    'trend.falling_rapidly': 'तेज़ी से घट रहा है',
    'trend.insufficient_data': 'सीख रहा है',

    // ── Status Badges ──
    'status.monitor': 'निगरानी',
    'status.recovery': 'सुधार',
    'status.learning': 'सीख रहा',
    'status.idle': 'प्रतीक्षा',
    'status.invalid': 'अमान्य',

    // ── Engine v2 Messages ──
    'engine.title_safe': 'भंडारण सुरक्षित है',
    'engine.title_warning': 'ध्यान दें',
    'engine.title_critical': 'कार्रवाई आवश्यक',
    'engine.title_monitor': 'करीब से निगरानी करें',
    'engine.title_recovery': 'स्थिति में सुधार',
    'engine.title_learning': 'डेटा एकत्र कर रहा',
    'engine.title_idle': 'प्रतीक्षा कर रहा...',
    'engine.title_invalid': 'प्रोब जांचें',
    'engine.safe_condition': 'सभी रीडिंग सामान्य सीमा में हैं।',
    'engine.safe_action': 'वर्तमान भंडारण स्थितियां बनाए रखें।',
    'engine.moisture_stable': 'स्थितियां स्थिर हैं। निगरानी विंडो में रीडिंग सुसंगत हैं।',
    'engine.stable_action': 'कोई कार्रवाई आवश्यक नहीं। निगरानी जारी रखें।',
    'engine.monitor_condition': 'नमी या तापमान सीमा के करीब पहुंच रहा है। करीबी निगरानी अनुशंसित।',
    'engine.monitor_action': 'वेंटिलेशन जांचें। परिवर्तनों पर नज़र रखें।',
    'engine.warning_condition': 'नमी सुरक्षित सीमा से ऊपर है। अनाज की गुणवत्ता गिरने का खतरा।',
    'engine.warning_action': 'भंडारण की जांच करें। वेंटिलेशन बेहतर करें या हवा दें।',
    'engine.high_moisture_warm': 'उच्च नमी और बढ़ा हुआ तापमान। सड़न का खतरा बढ़ रहा है।',
    'engine.high_moisture_warm_action': 'तुरंत कार्रवाई करें — अनाज में हवा दें, तापमान कम करें, गर्म बिंदुओं की जांच करें।',
    'engine.critical_condition': 'खतरनाक नमी और तापमान स्तर। सड़न अनिवार्य।',
    'engine.critical_action': 'तुरंत सुखाना शुरू करें। भंडारण सुविधा से संपर्क करें। देर न करें।',
    'engine.moisture_rising': 'नमी धीरे-धीरे बढ़ रही है। हाल की रीडिंग में रुझान पाया गया।',
    'engine.rising_action': 'करीब से निगरानी करें। नमी के स्रोतों या रिसाव की जांच करें।',
    'engine.moisture_rising_rapidly': 'नमी तेज़ी से बढ़ रही है। रीडिंग के बीच महत्वपूर्ण वृद्धि।',
    'engine.rising_rapidly_action': 'तुरंत जांच करें। वेंटिलेशन, संक्यंदन और अनाज की स्थिति जांचें।',
    'engine.recovery': 'भंडारण स्थितियां सुरक्षित स्तर पर लौट आई हैं। सुधार पाया गया।',
    'engine.recovery_action': 'स्थितियां सुधर रही हैं। वर्तमान प्रथाएं जारी रखें।',
    'engine.insufficient_data': 'विश्लेषण के लिए पर्याप्त डेटा नहीं। बेसलाइन स्थापित करने के लिए रीडिंग एकत्र कर रहा है।',
    'engine.insufficient_data_action': 'प्रोब कनेक्टेड रखें। अधिक रीडिंग के साथ विश्लेषण बेहतर होगा।',
    'engine.invalid_reading': 'सेंसर रीडिंग अमान्य लगती है। प्रोब कनेक्शन जांचें।',
    'engine.invalid_action': 'प्रोब सही ढंग से लगाया गया और कनेक्टेड है, सत्यापित करें।',
    'engine.stale_reading': 'डेटा पुराना है। हाल की रीडिंग नहीं मिलीं।',
    'engine.stale_action': 'प्रोब बैटरी और ब्लूटूथ कनेक्शन जांचें।',
    'engine.unknown': 'अज्ञात स्थिति।',
    'engine.unknown_action': 'स्थिति की निगरानी करें।',
    'engine.idle': 'रीडिंग की प्रतीक्षा...',
    'engine.idle_action': 'प्रोब कनेक्टेड है और डेटा भेज रहा है, सुनिश्चित करें।',
  ...
  mr: {
    ...
    'trend.drop': 'अचानक घट',
    'trend.rising_rapidly': 'झपाट्याने वाढत आहे',
    'trend.falling_rapidly': 'झपाट्याने कमी होत आहे',
    'trend.insufficient_data': 'शिकत आहे',

    // ── Status Badges ──
    'status.monitor': 'निरीक्षण',
    'status.recovery': 'सुधार',
    'status.learning': 'शिकत आहे',
    'status.idle': 'प्रतीक्षा',
    'status.invalid': 'अवैध',

    // ── Engine v2 Messages ──
    'engine.title_safe': 'साठा सुरक्षित आहे',
    'engine.title_warning': 'लक्ष द्या',
    'engine.title_critical': 'कार्यवाही आवश्यक',
    'engine.title_monitor': 'जवळून निरीक्षण करा',
    'engine.title_recovery': 'परिस्थितीत सुधार',
    'engine.title_learning': 'डेटा गोळा करत आहे',
    'engine.title_idle': 'प्रतीक्षा करत आहे...',
    'engine.title_invalid': 'प्रोब तपासा',
    'engine.safe_condition': 'सर्व रीडिंग सामान्य श्रेणीत आहेत.',
    'engine.safe_action': 'सध्याच्या साठा स्थिती राखा.',
    'engine.moisture_stable': 'परिस्थिती स्थिर आहेत. निरीक्षण विंडोमध्ये रीडिंग संगत आहेत.',
    'engine.stable_action': 'कोणतीही कार्यवाही आवश्यक नाही. निरीक्षण सुरू ठेवा.',
    'engine.monitor_condition': 'ओलावा किंवा तापमान सीमेजवळ येत आहे. जवळून निरीक्षण शिफारस.',
    'engine.monitor_action': 'वेंटिलेशन तपासा. बदलांवर लक्ष ठेवा.',
    'engine.warning_condition': 'ओलावा सुरक्षित मर्यादेपेक्षा जास्त. धान्य गुणवत्ता कमी होण्याचा धोका.',
    'engine.warning_action': 'साठा तपासा. वेंटिलेशन सुधारा किंवा हवा द्या.',
    'engine.high_moisture_warm': 'जास्त ओलावा आणि वाढलेले तापमान. सडण्याचा धोका वाढत आहे.',
    'engine.high_moisture_warm_action': 'तात्काळ कार्यवाही करा — धान्यात हवा द्या, तापमान कमी करा, गरम बिंदू तपासा.',
    'engine.critical_condition': 'धोकादायक ओलावा आणि तापमान पातळी. सडणे अनिवार्य.',
    'engine.critical_action': 'तात्काळ वाळवणे सुरू करा. साठा सुविधेशी संपर्क साधा. विलंब करू नका.',
    'engine.moisture_rising': 'ओलावा हळूहळू वाढत आहे. अलीकडील रीडिंगमध्ये ट्रेंड आढळला.',
    'engine.rising_action': 'जवळून निरीक्षण करा. ओलावाचे स्रोत किंवा गळती तपासा.',
    'engine.moisture_rising_rapidly': 'ओलावा झपाट्याने वाढत आहे. रीडिंगमध्ये महत्त्वपूर्ण वाढ.',
    'engine.rising_rapidly_action': 'तात्काळ तपासणी करा. वेंटिलेशन, कंडनेशन आणि धान्याची स्थिती तपासा.',
    'engine.recovery': 'साठा परिस्थिती सुरक्षित पातलीवर परत आल्या आहेत. सुधार आढळला.',
    'engine.recovery_action': 'परिस्थिती सुधरत आहेत. सध्याच्या पद्धती चालू ठेवा.',
    'engine.insufficient_data': 'विश्लेषणासाठी पुरेसा डेटा नाही. बेसलाइन स्थापित करण्यासाठी रीडिंग गोळा करत आहे.',
    'engine.insufficient_data_action': 'प्रोब कनेक्टेड ठेवा. अधिक रीडिंगसह विश्लेषण अधिक चांगले होईल.',
    'engine.invalid_reading': 'सेन्सर रीडिंग अवैध दिसत आहे. प्रोब कनेक्शन तपासा.',
    'engine.invalid_action': 'प्रोब योग्यरित्या बसवलेले आहे आणि कनेक्टेड आहे, सत्यापित करा.',
    'engine.stale_reading': 'डेटा जुना आहे. अलीकडील रीडिंग मिळाल्या नाहीत.',
    'engine.stale_action': 'प्रोब बॅटरी आणि ब्लूटूथ कनेक्शन तपासा.',
    'engine.unknown': 'अज्ञात स्थिती.',
    'engine.unknown_action': 'परिस्थितीचे निरीक्षण करा.',
    'engine.idle': 'रीडिंगची प्रतीक्षा...',
    'engine.idle_action': 'प्रोब कनेक्टेड आहे आणि डेटा पाठवत आहे, सुनिश्चित करा.',
  ...
  hinglish: {
    ...
    'trend.spike': 'Spike',
    'trend.drop': 'Drop',
    'trend.rising_rapidly': 'Fast Badh Raha Hai',
    'trend.falling_rapidly': 'Fast Gir Raha Hai',
    'trend.insufficient_data': 'Seekh Raha Hai',
    ...
    // ── Engine v2 Messages ──
    'engine.title_safe': 'Storage Safe Hai',
    'engine.title_warning': 'Dhyaan Do',
    'engine.title_critical': 'Action Chahiye',
    'engine.title_monitor': 'Close Monitor Karo',
    'engine.title_recovery': 'Conditions Improve Hui',
    'engine.title_learning': 'Data Collect Ho Raha Hai',
    'engine.title_idle': 'Wait Kar Raha Hai...',
    'engine.title_invalid': 'Probe Check Karo',
    'engine.safe_condition': 'Sab readings normal range mein hain.',
    'engine.safe_action': 'Current storage conditions maintain karo.',
    'engine.moisture_stable': 'Conditions stable hain. Monitoring window mein readings consistent hain.',
    'engine.stable_action': 'Koi action nahi chahiye. Monitoring continue rakho.',
    'engine.monitor_condition': 'Moisture ya temperature threshold ke paas pahunch raha hai. Close monitoring recommended.',
    'engine.monitor_action': 'Ventilation check karo. Changes par nazar rakho.',
    'engine.warning_condition': 'Moisture safe limit se upar hai. Grain quality degrade hone ka risk.',
    'engine.warning_action': 'Storage inspect karo. Ventilation improve karo ya aeration shuru karo.',
    'engine.high_moisture_warm': 'High moisture aur elevated temperature. Spoilage risk badh raha hai.',
    'engine.high_moisture_warm_action': 'Immediately act karo — grain ko aerate karo, temperature reduce karo, hot spots check karo.',
    'engine.critical_condition': 'Dangerous moisture aur temperature levels. Spoilage imminent hai.',
    'engine.critical_action': 'Turant drying shuru karo. Storage facility se contact karo. Delay mat karo.',
    'engine.moisture_rising': 'Moisture gradually badh rahi hai. Recent readings mein trend detect hua.',
    'engine.rising_action': 'Closely monitor karo. Moisture sources ya leaks check karo.',
    'engine.moisture_rising_rapidly': 'Moisture rapidly badh rahi hai. Readings ke beech significant increase.',
    'engine.rising_rapidly_action': 'Immediately investigate karo. Ventilation, condensation, aur grain condition check karo.',
    'engine.recovery': 'Storage conditions safe levels par wapas aa gaye hain. Improvement detect hui.',
    'engine.recovery_action': 'Conditions improve ho rahi hain. Current practices continue rakho.',
    'engine.insufficient_data': 'Analysis ke liye kaafi data nahi. Baseline establish karne ke liye readings collect ho rahi hain.',
    'engine.insufficient_data_action': 'Probe connected rakho. Zyada readings ke saath analysis improve hoga.',
    'engine.invalid_reading': 'Sensor reading invalid lag rahi hai. Probe connection check karo.',
    'engine.invalid_action': 'Probe properly inserted aur connected hai, verify karo.',
    'engine.stale_reading': 'Data purana hai. Koi recent reading nahi mili.',
    'engine.stale_action': 'Probe battery aur Bluetooth connection check karo.',
    'engine.unknown': 'Unknown state.',
    'engine.unknown_action': 'Situation monitor karo.',
    'engine.idle': 'Readings ka wait ho raha hai...',
    'engine.idle_action': 'Probe connected hai aur data bhej raha hai, ensure karo.',
